...
public class CampaignNameEqualConstraint : Constraint
{
    private readonly string _expectedValue;
    public override string Description { get => $"Campaign Name Equal expected value: {_expectedValue}"; }
    public CampaignNameEqualConstraint(string expectedValue)
    {
