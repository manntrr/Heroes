...
public class HeroesTests
{
    ...
    public void NullConstructorTest()
    {
        ...
        Assert.That(heroes.GameMasters.ElementAt(0).Value.GenreKeys.Count, Is.EqualTo(1));
        Assert.That(heroes.GameMasters.ElementAt(0).Value.GenreKeys.ElementAt(0), Is.EqualTo("Genre 1"));
        Assert.That(heroes.GameMasters.ElementAt(0).Value.GameMasters, Is.Null);
        Assert.That(heroes.GameMasters.ElementAt(0).Value.CampaignKeys.Count, Is.EqualTo(1));
    ...
    public void GeneratedSingleNonPlayerCharacterConstructorTest()
    {
        ...
        Assert.That(heroes.NonPlayerCharacters.ElementAt(0).Value.GameMasters.ElementAt(0).Value.GenreKeys.Count, Is.EqualTo(1));
        Assert.That(heroes.NonPlayerCharacters.ElementAt(0).Value.GameMasters.ElementAt(0).Value.GenreKeys.ElementAt(0), Is.EqualTo("Genre 1"));
        Assert.That(heroes.NonPlayerCharacters.ElementAt(0).Value.GameMasters.ElementAt(0).Value.CampaignKeys.Count, Is.EqualTo(1));
        Assert.That(heroes.NonPlayerCharacters.ElementAt(0).Value.GameMasters.ElementAt(0).Value.CampaignKeys.Keys.ElementAt(0), Is.EqualTo("Campaign 1"));
