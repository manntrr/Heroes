...
public class HeroesTests
{
    ...
    public void NullConstructorTest()
    {
        ...
        Assert.That(heroes.GameMasters.ElementAt(0).Value.Name, Is.EqualTo("Unknown"));
        Assert.That(heroes.GameMasters.ElementAt(0).Value.Genres.Count, Is.EqualTo(1));
        Assert.That(heroes.GameMasters.ElementAt(0).Value.Genres.ElementAt(0), Is.EqualTo("Genre 1"));
        Assert.That(heroes.GameMasters.ElementAt(0).Value.GameMasters, Is.Null);
        Assert.That(heroes.GameMasters.ElementAt(0).Value.Campaigns.Count, Is.EqualTo(1));
        Assert.That(heroes.GameMasters.ElementAt(0).Value.Campaigns.ElementAt(0), Is.EqualTo("Campaign 1"));
        ...
        Assert.That(heroes.Players.ElementAt(0).Value.Genres.Count, Is.EqualTo(1));
        Assert.That(heroes.Players.ElementAt(0).Value.Genres.ElementAt(0), Is.EqualTo("Genre 1"));
        Assert.That(heroes.Players.ElementAt(0).Value.GameMasters, Is.Null);
        Assert.That(heroes.Players.ElementAt(0).Value.Campaigns.Count, Is.EqualTo(1));
        Assert.That(heroes.Players.ElementAt(0).Value.Campaigns.ElementAt(0), Is.EqualTo("Campaign 1"));
    ...
    public void GeneratedSingleNonPlayerCharacterConstructorTest()
    {
        ...
        Assert.That(heroes.NonPlayerCharacters.ElementAt(0).Value.GameMasters.ElementAt(0).Key, Is.EqualTo("Game Master 1"));
        Assert.That(heroes.NonPlayerCharacters.ElementAt(0).Value.GameMasters.ElementAt(0).Value.Key, Is.EqualTo("Game Master 1"));
        Assert.That(heroes.NonPlayerCharacters.ElementAt(0).Value.GameMasters.ElementAt(0).Value.Name, Is.EqualTo("Unknown"));
        Assert.That(heroes.NonPlayerCharacters.ElementAt(0).Value.GameMasters.ElementAt(0).Value.Genres.Count, Is.EqualTo(1));
        Assert.That(heroes.NonPlayerCharacters.ElementAt(0).Value.GameMasters.ElementAt(0).Value.Genres.ElementAt(0), Is.EqualTo("Genre 1"));
        Assert.That(heroes.NonPlayerCharacters.ElementAt(0).Value.GameMasters.ElementAt(0).Value.Campaigns.Count, Is.EqualTo(1));
